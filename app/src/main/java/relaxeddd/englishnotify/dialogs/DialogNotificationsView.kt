...
class DialogNotificationsView : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return activity?.let {
            ...
            builder.setTitle(R.string.notifications_view)
                .setSingleChoiceItems(R.array.array_notifications_view, selectedItemIx) { _, which ->
